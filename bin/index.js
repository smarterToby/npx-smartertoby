...
const startPrompt = () => {
    ...
    const handleEmailOptions = () => {
        ...
        console.log('\n' + chalk.red.bold('Email:') + ' ' + chalk.white(user.email));
            ...
            .then(answers => {
                ...
                switch (answers.emailOption) {
                    case 'Write Email':
                        ...
                        console.log(chalk.italic('Your standard mail program opened.\n\nI look forward to hearing from you!\nGoodbye!'));
                        break;
                    case 'Copy Email':
                        clipboardy.writeSync(user.email)
                        console.log(chalk.italic('Email was copied to your clipboard!\n\nI look forward to hearing from you!'));
                        break;
                    case 'Just quit':
                        console.log('Goodbye!');
                        break;
